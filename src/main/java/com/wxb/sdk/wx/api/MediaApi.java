...
import com.wxb.sdk.wx.utils.IOUtils;
...
public class MediaApi {
	...
	public static ApiResult uploadMedia(MediaType mediaType, File file) {
		String url = upload_url + AccessTokenApi.token() + "&type=" + mediaType.get();
		try {
	...
	public static MediaFile getMedia(String media_id) {
		String url = get_url + AccessTokenApi.token() + "&media_id=" + media_id;
		try {
			return download(url);
		} catch (IOException e) {
			throw new RuntimeException(e);
	...
	public static ApiResult addNews(List<MediaArticles> mediaArticles) {
		String url = add_news_url + AccessTokenApi.token();
		
		Map<String, Object> dataMap = new HashMap<String, Object>();
		dataMap.put("articles", mediaArticles);
		
		String jsonResult = HttpKit.post(url, JSON.toJSONString(dataMap));
	...
	public static ApiResult uploadImg(File imgFile) {
		String url = uploadImgUrl + AccessTokenApi.token();
		try {
	...
	public static ApiResult addMaterial(File file) {
		String url = addMaterialUrl + AccessTokenApi.token();
	...
	public static ApiResult addMaterial(File file, String title, String introduction) {
		...
		try {
			return uploadMedia(url, file, JSON.toJSONString(dataMap));
		} catch (IOException e) {
			throw new RuntimeException(e);
		}
	}
	...
	public static InputStream getMaterial(String media_id) {
		String url = get_material_url + AccessTokenApi.token();
		
		Map<String, Object> dataMap = new HashMap<String, Object>();
		dataMap.put("media_id", media_id);
		
		try {
			return downloadMaterial(url, JSON.toJSONString(dataMap));
		} catch (IOException e) {
			throw new RuntimeException(e);
		}
	}
	...
	public static ApiResult delMaterial(String media_id) {
		String url = del_material_url + AccessTokenApi.token();
	...
	public static ApiResult updateNews(String media_id, int index, MediaArticles mediaArticles) {
		String url = update_news_url + AccessTokenApi.token();
	...
	public static ApiResult getMaterialCount() {
		String url = get_materialcount_url + AccessTokenApi.token();
	...
	public static ApiResult batchGetMaterial(MediaType mediaType, int offset, int count) {
		String url = batchget_material_url + AccessTokenApi.token();
