...
public class CustomServiceApi {
    ...
    private static String customMessageUrl = "https://api.weixin.qq.com/cgi-bin/message/custom/send";
    ...
    private static ApiResult sendMsg(Map<String, Object> message) {
        return new ApiResult(HttpKit.post(customMessageUrl, ParaMap.createToken().getData(), JSON.toJSONString(message)));
    }
