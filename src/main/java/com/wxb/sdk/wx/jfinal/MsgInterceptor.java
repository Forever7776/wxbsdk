...
import com.wxb.sdk.wx.kit.SignatureCheckKit;
...
public class MsgInterceptor implements Interceptor {
	...
	public void intercept(Invocation ai) {
		...
		try {
			...
			ApiConfigKit.setThreadLocalApiConfig(((MsgController) controller).getApiConfig(id));
            ...
            log.error("MsgInterceptor@intercept error",e);
        }
		finally {
