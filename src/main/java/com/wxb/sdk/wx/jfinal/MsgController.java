...
import com.wxb.sdk.wx.api.ApiConfig;
import com.wxb.sdk.wx.api.ApiConfigKit;
import com.wxb.sdk.wx.kit.MsgEncryptKit;
import com.wxb.sdk.wx.msg.InMsgParaser;
import com.wxb.sdk.wx.msg.OutMsgXmlBuilder;
...
import com.wxb.sdk.wx.msg.out.OutMsg;
import com.wxb.sdk.wx.msg.out.OutTextMsg;
...
public abstract class MsgController extends Controller {
	...
	public abstract ApiConfig getApiConfig(String id);
...
//		renderText("SUCCESS");
		...
		else if (msg instanceof InPoiCheckEvent)
			processInPoiCheckEvent((InPoiCheckEvent)msg);
	...
	// 处理接收到的门店审核结果
	protected abstract void processInPoiCheckEvent(InPoiCheckEvent inPoiCheckEvent);
