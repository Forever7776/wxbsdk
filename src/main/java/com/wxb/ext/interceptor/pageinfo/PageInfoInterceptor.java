...
public abstract class PageInfoInterceptor extends PrototypeInterceptor {
    ...
    private Map<String,Object> paraMap = Maps.newHashMap();

    public abstract void config(Controller cl);
    ...
    public PageInfoInterceptor addPara(String key,Object value){
    ...
    public void doIntercept(Invocation ai) {
        ...
        config(controller);
        PageInfo pageInfo = PageInfoKit.injectPageInfo(model, controller,relations,paraMap);
